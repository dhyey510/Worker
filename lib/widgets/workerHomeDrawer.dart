...
class WorkerHomeDrawer extends StatefulWidget {
  @override
  _WorkerHomeDrawerState createState() => _WorkerHomeDrawerState();
}

class _WorkerHomeDrawerState extends State<WorkerHomeDrawer> {
      ...
      child: ListView(
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).pushNamed(EditProfile.EditProfileRoute,arguments: {'curWorker':obj});
            },
          ),
          // ListTile(
          //   contentPadding: EdgeInsets.symmetric(horizontal: 7, vertical: 3),
